...
def parse_args():
    ...
    parser.add_argument(
        '--voc_dir', dest='voc_dir', default='data/VOCdevkit', type=str)
    parser.add_argument('--year', dest='year', default='2017', type=str)
    parser.add_argument(
        '--image_set', dest='image_set', default='test', type=str)

    parser.add_argument(
        '--classes', dest='class_file', default='data/voc.names', type=str)
...
def do_python_eval(devkit_path, year, image_set, classes,
                   output_dir='results'):
...
if __name__ == '__main__':
    ...
    do_python_eval(args.voc_dir, args.year, args.image_set, classes,
                   output_dir)
